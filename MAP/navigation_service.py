...
DAYLIGHT_CAUTION_MIN = int(os.getenv("SAFEAID_DAYLIGHT_CAUTION_MIN", "30"))
NAVIGATION_SPEED_MPS = float(os.getenv("SAFEAID_NAVIGATION_SPEED_MPS", "1.0"))
ARRIVAL_RADIUS_M = float(os.getenv("SAFEAID_ARRIVAL_RADIUS_M", "10"))
ARRIVAL_MAX_ACCURACY_M = float(os.getenv("SAFEAID_ARRIVAL_MAX_ACCURACY_M", "20"))
